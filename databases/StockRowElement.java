...
public class StockRowElement extends RowElement<Double> {
   // ArrayList<Double> myData;
    ...
    public StockRowElement () {
        super.myData = (ArrayList<Double>) new ArrayList<Double>();
    }
    ...
    public void addData (String rdata) {
        try {
            ...
            try {
                super.myData.add(new Double(new java.text.SimpleDateFormat ("ddMMyyyy").parse(result).getTime()/1000));
            }
    ...
    public Double getPrimaryValue () {
        return (Double) super.myData.get(myPrimaryIndex);
    }
